...
class TrainOptions:
	...
	def initialize(self):
		...
		self.parser.add_argument('--is_train', default=False, type=bool, help='Batch size for training')
		...
		self.parser.add_argument('--latent_lambda', default=0, type=float, help='ID loss multiplier factor')
		...
		self.parser.add_argument('--save_model_dir', default='./', type=str, help='Which optimizer to use')
		self.parser.add_argument('--resume_iter', default=0, type=int, help='Maximum number of training steps')
		self.parser.add_argument('--sample_num', default=1, type=int, help='Maximum number of training steps')
		...
		self.parser.add_argument('--select_celeba_id', default=0, type=int, help='Validation interval')
		self.parser.add_argument('--train_d', action="store_true", help='Model checkpoint interval')
